...
macro(AddSwigLibrary NamePy SwigFile)
  ...
  set(SWIG_FLAGS "${SWIG_FLAGS};-DVISUS_GUI=${VISUS_GUI}")
	...
	target_compile_definitions(${_target_name_} PRIVATE NUMPY_FOUND=${NUMPY_FOUND})
	target_compile_definitions(${_target_name_} PRIVATE VISUS_GUI=${VISUS_GUI})
