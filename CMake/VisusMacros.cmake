...
macro(AddSwigLibrary NamePy SwigFile)
  ...
  set(SWIG_FLAGS "${SWIG_FLAGS};-extranative")
   ...
   if (VISUS_GUI)
  		set(SWIG_FLAGS "${SWIG_FLAGS};-DVISUS_GUI=1")
   else()
  		set(SWIG_FLAGS "${SWIG_FLAGS};-DVISUS_GUI=0")
   endif()
	...
	if (VISUS_GUI)
		target_compile_definitions(${_target_name_} PRIVATE VISUS_GUI=1)
	else()
		target_compile_definitions(${_target_name_} PRIVATE VISUS_GUI=0)
	endif()
