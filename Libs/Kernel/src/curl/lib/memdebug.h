...
void *curl_docalloc(size_t elements, size_t size, int line,
                                const char *source);
void *curl_dorealloc(void *ptr, size_t size, int line,
                                 const char *source);
void curl_dofree(void *ptr, int line, const char *source);
char *curl_dostrdup(const char *str, int line, const char *source);
#if defined(WIN32) && defined(UNICODE)
wchar_t *curl_dowcsdup(const wchar_t *str, int line,
                                   const char *source);
#endif
...
SEND_TYPE_RETV curl_dosend(SEND_TYPE_ARG1 sockfd,
                                       ...
                                       const char *source);
RECV_TYPE_RETV curl_dorecv(RECV_TYPE_ARG1 sockfd,
