...
class TestAPI(unittest.TestCase):
	...
	def test_load_dataset(self):
		dataset = ov.load_dataset(f"http://{DOMAIN}/open-scivis-datasets/silicium/silicium.idx")
		...
		with self.assertRaises(FileNotFoundError):
			dataset = ov.load_dataset(f"http://{DOMAIN}/open-scivis-datasets/silicium/silicium.idx_")
	...
	def test_cache_dir(self):
		...
		with self.assertRaises(NotADirectoryError):	
			with open("test.txt", "w") as f:
				f.write("hello\n")
			dataset = ov.load_dataset(f"http://{DOMAIN}/open-scivis-datasets/silicium/silicium.idx", cache_dir="test.txt")
